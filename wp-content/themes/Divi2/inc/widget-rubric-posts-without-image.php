...
class I_Widget_Rubric_Post_Without_Image extends WP_Widget{
    public function __construct()
    {
        parent::__construct('I_Widget_Rubric_Post_Without_Image', 'Itkor - Выводит посты рубрики без картинки',
            [
                'name' => 'Itkor - Виджет с выбором рубрики постов, которые будут отображаться (без картинки)',
                'description' => 'Выводит посты рубрики без картинки',
            ]
        );
    }
